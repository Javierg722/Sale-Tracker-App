...
## Cache-safe updates
- This build uses service worker cache version **v8**.
...
## Cache-proofing
- Service worker cache name bumped to `sale-tracker-pwa-v8`
...
- The app header shows **Build v8** so you can confirm the live build
